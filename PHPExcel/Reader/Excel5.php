...
[1]
                switch ($extType) {
                    case 4:        // fill start color
                        ...
                        if ($xclfType == 2) {
                            $rgb = sprintf('%02X%02X%02X', ord($xclrValue[0]), ord($xclrValue{
                            1}), ord($xclrValue{
                            2}));
                            ...
                            if (isset($this->mapCellXfIndex[$ixfe])) {
                                ...
                                unset($fill->startcolorIndex); // normal color index does not[1]ply, discard
                            }
                        }
                        break;
                    case 5:        // fill end color
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property
                            if (isset($this->mapCellXfIndex[$ixfe])) {
                                $fill = $this->phpExcel->getCellXfByIndex($this->mapCellXfInd[1]$ixfe])->getFill();
                    ...
                    case 7:        // border color top
                        ...
                        if ($xclfType == 2) {
                            ...
                            // modify the relevant style property[1]
                            if (isset($this->mapCellXfIndex[$ixfe])) {
                    ...
                    case 9:        // border color left
                        ...
                        if ($xclfType == 2) {
                            $rgb = sprintf('%02X%02X%02X', ord($xclrValue[0]), ord($xclrValue[1]
                            1}), ord($xclrValue{
                            2}));
...
[1]
                    ...
                    case 11:        // border color diagonal
                        $xclfType  = self::getInt2d($extData, 0); // color type[1]
                        $xclrValue = substr($extData, 4, 4); // color value (value based on color type)
    ...
    private function readPane()
    {
        ...
        if (!$this->readDataOnly) {
            // offset: 0; size: 2; position of vertical split[1]
...
[1]
            if ($this->frozen) {
                ...
                // unfrozen panes; split windows; not supported by PHPExcel c[1]
            }
        }
    }
